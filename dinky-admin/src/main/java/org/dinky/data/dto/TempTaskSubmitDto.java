...
@Data
@Builder
public class TempTaskSubmitDto {
    public TempTaskSubmitDto() {}

    public TempTaskSubmitDto(Integer id, Boolean isOnline, String savePointPath, Map<String, String> variables, String statement) {
        this.id = id;
